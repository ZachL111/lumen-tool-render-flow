"""Regression checks for the lumen-tool-render-flow casebook."""
...
from casebook.harness import assert_expected, lumen_tool_render_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lumen_tool_render_flow_summary(), assert_expected())
