...
lumen-tool-render-flow is a Python project for cli tools. It focuses on this technical goal: Package a Python local lab for render analysis with node-edge fixtures, cycle and reachability reports, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 177, risk penalty 7, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
